    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('antrean.pendaftaran.tanggal.index')" :active="request()->routeIs('antrean.pendaftaran.tanggal.index')">
                        {{ __('Antrian Per Tanggal') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('jadwal.operasi.index')" :active="request()->routeIs('jadwal.operasi.index')">
                        {{ __('Jadwal Operasi') }}
                    </x-nav-link>
                </div>
